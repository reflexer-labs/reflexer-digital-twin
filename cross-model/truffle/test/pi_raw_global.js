...
contract('PIRawGlobalValidator', function(accounts) {
  // Default params
  ...
  var lowerPrecomputedRateAllowedDeviation  = new BN("950000000000000000");
  var upperPrecomputedRateAllowedDeviation  = new BN("950000000000000000");
  ...
  var noiseBarrier                          = new BN("998000000000000000"); // 0.2%
  ...
  async function executePIUpdate(print, randomDelay, randomPrice) {
    ...
    var offChainPythonRedemptionRate;
    var offChainBashRedemptionRate;
    ...
    if (print) {
      ...
      console.log("Python Computed Per-Second Redemption Rate (Un-trimmed): " + offChainPythonRedemptionRate)
      console.log("Bash Computed Per-Second Redemption Rate (Un-trimmed): " + offChainBashRedemptionRate)
      console.log("Market Price: " + randomPrice.toString(10))
      console.log("Redemption Price: " + latestRedemptionPrice)
      console.log("Global Un-trimmed Redemption Rate: " + normalizedGlobalRate)
  ...
  it('should simulate a huge positive shock and then a comeback to the redemption price', async () => {
    ...
    var printStep       = false;
    var simDataFilePath = "test/saved_sims/pi_global/raw/big_positive_shock.txt";
  ...
  it('should simulate a huge negative shock and then a comeback to the redemption price', async () => {
    ...
    var printOverview   = false;
    var printStep       = false;
    var simDataFilePath = "test/saved_sims/pi_global/raw/big_negative_shock.txt";
  ...
  it("should do a positive step change in the market price over one year (with compounding)", async () => {
    ...
    var printOverview   = false;
    var printStep       = true;
    var simDataFilePath = "test/saved_sims/pi_global/raw/one_year_positive_step_change_with_compounding.txt";
    ...
    await logging.printAndSaveSimulation(
      ...
      integralWithGain,
      delays,
      (integralPeriodSize * (loops + 1)).toString(),
  ...
  it("should do a negative step change in the market price over one year (with compounding)", async () => {
    ...
    var printOverview   = false;
    var printStep       = false;
    var simDataFilePath = "test/saved_sims/pi_global/raw/one_year_negative_step_change_with_compounding.txt";
  ...
  it('should simulate the PI raw validator using a predefined scenario', async () => {
    ...
    var printOverview   = false;
    var printStep       = false;
    var simDataFilePath = "test/saved_sims/pi_global/raw/predefined_scenario.txt";
  ...
  it('should simulate the PI raw validator using randomly generated prices and delays', async () => {
    // Params
    var priceLowerBound = 3.6;
    var priceUpperBound = 5.0;
    ...
    var printOverview   = false;
    var printStep       = false;
    var simDataFilePath = "test/saved_sims/pi_global/raw/randomly_generated_prices_and_delays.txt";
