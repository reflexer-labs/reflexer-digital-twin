...
contract('PIScaledGlobalValidator Imported Config', function(accounts) {
  // Default params
  ...
  async function importVariables() {
    let piParams = fs.readFileSync('test/config/pi_global_scaled.json');
  ...
  it('simulate the scaled PI global controller using the custom JSON config', async () => {
